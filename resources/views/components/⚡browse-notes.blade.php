...
// 6. Update UI (Livewire event) with the sum
    ...
    // Static Filter: Only take papers with type 'Notes'
    ->where('type', 'Notes')
...
<div>
   ...
   <div class="min-h-screen bg-gray-50 mt-20 font-sans">

    <main class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <!-- Search Section -->
        <div class="text-center mb-12">
            <h1 class="text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">Browse Academic Notes</h1>
