        ...
        <div class="bg-white px-8 py-10 shadow-xl shadow-slate-200/50 rounded-2xl border border-slate-100">
            <form class="space-y-5" action="#" method="POST">
                <div>
                    ...
                    <input id="email" name="email" type="email" required
                        class="mt-1 block w-full rounded-lg border-slate-200 px-4 py-2.5 text-slate-900 shadow-sm focus:border-[#1c7ed6] focus:ring-[#1c7ed6] sm:text-sm">
                </div>
                ...
                <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox" class="h-4 w-4 px-4 rounded border-slate-300 text-[#1c7ed6] focus:ring-[#1c7ed6]">
            ...
            <div class="mt-8 pt-6 border-t border-slate-100 text-center">
                <p class="text-sm text-slate-500">
                    New to Protrixx?
                    <a href="/signup" class="font-bold text-[#1c7ed6] hover:underline">Create an account</a>
                </p>
            </div>
        </div>
    </div>
